...
set "PS1=%SCRIPT_DIR%\scripts\deploy_windows_5070ti.ps1"
set "LOG_PATH=%SCRIPT_DIR%\deploy_run_5070ti.log"
...
echo [INFO] MotionBERT Windows 5070 Ti one-click deploy
